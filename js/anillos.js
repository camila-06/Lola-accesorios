...
obtenerProductos().then(productos => {
    filter = productos.filter(elem => elem.tipo == "Anillo")
...
function buscar (){
    ...
    switch (buscado){
        ...
        case "aros":
            ...
            break;
        case "pulseras":
            link.setAttribute("href", "pulseras.html")
            link.click();
            break;
        case "collares":
            ...
            break;
        case "bufandas":
            link.setAttribute("href", "bufandas.html")
            link.click();
            break;
        case "gorros":
            link.setAttribute("href", "gorros.html")
            link.click();
            break;
        default:
            Swal.fire({
