...
obtenerProductos().then(productos => {
    ...
    card.setAttribute("class", "card tarjeta");
...
function buscar (){
    ...
    switch (buscado){
        case "anillos":
            link.setAttribute("href", "pages/anillos.html")
            link.click();
            break;
        case "aros":
            link.setAttribute("href", "pages/aros.html")
            link.click();
            break;
        case "pulseras":
            link.setAttribute("href", "pages/pulseras.html")
            link.click();
            break;
        case "collares":
            link.setAttribute("href", "pages/collares.html")
            link.click();
            break;
        case "bufandas":
            link.setAttribute("href", "pages/bufandas.html")
            link.click();
            break;
        case "gorros":
            link.setAttribute("href", ".pages/gorros.html")
            link.click();
            break;
        default:
            Swal.fire({
